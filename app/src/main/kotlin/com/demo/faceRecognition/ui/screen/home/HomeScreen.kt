package com.demo.faceRecognition.ui.screen.home
...
import com.demo.faceRecognition.ui.navigation.HomeHost
import com.demo.faceRecognition.data.model.AppState
import com.demo.faceRecognition.ui.screen.home.HomeScreenState.Companion.defaultBottomBarItem
...
fun HomeScreen(appState: AppState, vm: HomeViewModel = hiltViewModel()) {
    ...
    Scaffold(
        ...
        content = { padding -> HomeHost(state = appState,
            startDestination = defaultBottomBarItem.route.path,
            host = home, modifier = Modifier.padding(padding)) }
    )
